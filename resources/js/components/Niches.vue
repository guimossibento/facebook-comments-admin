...
export default {
    ...
    methods: {
        ...
        getResults(page = 1) {
            ...
            axios.get('api/niches?page=' + page).then(({data}) => (this.niches = data.data));
        ...
        updateNiche() {
            ...
            this.form.put('api/niches/' + this.form.id)
                .then((response) => {
                    // success
                    $('#addNew').modal('hide');
                    Toast.fire({
        ...
        deleteNiche(id) {
            Swal.fire({
                ...
                if (result.value) {
                    this.form.delete('api/niches/' + id)
                        .then(() => {
                            Swal.fire(
                                'Apagado!',
                                'Item foi apagado.',
